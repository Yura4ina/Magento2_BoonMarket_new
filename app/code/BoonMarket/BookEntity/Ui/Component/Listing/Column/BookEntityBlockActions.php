...
namespace BoonMarket\BookEntity\Ui\Component\Listing\Column;
 ...
 */
class BookEntityBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'BookEntity';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'book_entity/bookentity/edit';
    private const DELETE_URL_PATH = 'book_entity/bookentity/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[BookEntityInterface::BOOK_ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [BookEntityInterface::BOOK_ENTITY_ID => $item[BookEntityInterface::BOOK_ENTITY_ID]];
