...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'BoonMarket_AddWidgetButton' => 1,
        'BoonMarket_ContactFormWidget' => 1,
        'BoonMarket_CustomFieldsModule' => 1,
        'BoonMarket_DataPatch' => 1,
        'BoonMarket_HowWeWorkWidget' => 1,
        'BoonMarket_Newsletters' => 1,
        'BoonMarket_PhotoGallerySec' => 1,
        'BoonMarket_Sec6SlWidget' => 1,
        'BoonMarket_ShopSectionWidget' => 1,
        'BoonMarket_WhatFreshWidget' => 1,
